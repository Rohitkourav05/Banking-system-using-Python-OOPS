class Bank:
    ...
    def register(self, name, ph, password):
        ...
        if len(str(ph)) > 10 or len(str(ph))< 10:
            ...
            print('Enter Password greater than 5 and less than 18 chracter')
            conditions = False 
    ...
    def password_change(self, password):
        if len(password ) < 5 or len(password) > 18:
            ...
            with open(f'{self.add_cash_name}.txt', 'w') as f:
    ...
    def ph_change(self, ph):
        if len(str(ph)) > 10 or len(str(ph)) < 10 :
            ...
            with open(f'{self.add_cashname}.txt', 'w') as f:
        ...
        while True :
            if Bank_object.loggedin:
                ...
                if login_user == 1:
                    ...
                    if edit_profile == 1:
                        new_password = input('Enter new Pssword: ')
